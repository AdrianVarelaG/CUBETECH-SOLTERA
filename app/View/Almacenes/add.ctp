        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Add Almacen'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo'<div class="col-md-9">';			
echo $this->Form->input('almacentipo_id', array('empty'=>'--Seleccione--','id'=>'Almacenealmacentipo_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('nombre', array('id'=>'Almacenenombre', 'div'=>false, 'label'=>false, 'class'=>'form-control', 'onBlur'=>'validar_nombre_almacen();'));		
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('foraneo', array('options'=>array('1'=>' Si ', '2'=>' No '), 'value'=>1, 'type'=>'radio','id'=>'Almaceneforaneo', 'div'=>false, 'label'=>false, 'class'=>''));		
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('maquila', array('options'=>array('1'=>' Si ', '2'=>' No '), 'value'=>1,  'type'=>'radio','id'=>'Almacenemaquila', 'div'=>false, 'label'=>false, 'class'=>''));		
echo '</div>';	
echo '</div>';
	?>
							</div>
