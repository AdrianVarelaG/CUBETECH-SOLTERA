...
<section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo __('Estados'); ?> Detalles</h3>
                        <hr>
                    </div><!-- /.box-header -->
                    <div class="box-body">
		...
		<dd>
			<?php echo h($direprovincia['Direprovincia']['denominacion']); ?>
			&nbsp;
		</dd>
						</dl>
						<p>
						    		<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $direprovincia['Direprovincia']['id'])); ?>
                            |
...
<?php /* ?><div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Direprovincia'), array('action' => 'edit', $direprovincia['Direprovincia']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Direprovincia'), array('action' => 'delete', $direprovincia['Direprovincia']['id']), array(), __('Are you sure you want to delete # %s?', $direprovincia['Direprovincia']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($direprovincia['Empresa'])): ?>
	...
	<?php foreach ($direprovincia['Empresa'] as $empresa): ?>
		<tr>
