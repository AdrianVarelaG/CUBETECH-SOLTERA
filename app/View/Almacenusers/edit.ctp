        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Almacen usuarios'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo'<div class="col-md-9">';			
echo $this->Form->input('user_id', array('id'=>'Almacenuseruser_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
	?>
							</div>
...
<?php /* ?>	<div class="actions">
		...
		<ul>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Almacenuser.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Almacenuser.id'))); ?></li>
