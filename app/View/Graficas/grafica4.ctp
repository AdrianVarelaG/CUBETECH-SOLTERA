...
<section class="content-header">
  <h1>
    Sistema de gestión
    <small><?php echo __('Grafica Stock de materiales'); ?></small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?= $this->Html->url('/Dashboard/')?>"><i class="fa fa-newspaper-o"></i> Inicio</a></li>
    <li class="active"><?php echo __('Grafica Stock de materiales'); ?></li>
  </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box"> 
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Grafica Stock de materiales'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
					<?php echo $this->Form->create('Grafica', array('class'=>'form-horizontal', 'url'=>'/Graficas/grafica4/1')); ?>
					<div class='row'>
							<div class='col-md-12'>
							<?php
                            ...
                            <div class='col-md-12'>
                               ...
                               Highcharts.getOptions().colors = Highcharts.map(Highcharts.getOptions().colors, function (color) {
                                ...
                                Highcharts.chart('container', {
                                    ...
                                    title: {
                                        text: 'Grafica Stock de materiales'
                                    },
                                    tooltip: {
                                    ...
                                    series: [{
                                        ...
                                        data:[
                                                <?php  $total = 0;
                                                       foreach($inventariomovimateriales as $inventariomovimateriale){
                                                           $total += ($inventariomovimateriale[0]['entrada']-$inventariomovimateriale[0]['salida']);
                                                       }
                                                ?>
                                                <?php  foreach($inventariomovimateriales as $inventariomovimateriale):
                                                           $cantidad   = ($inventariomovimateriale[0]['entrada']-$inventariomovimateriale[0]['salida']);
                                                           if($total==0){
                                                                   $porcentaje = 0;
                                                           }else{  
                                                                   $porcentaje = (($cantidad * 100)/$total);
                                                           }
                                                           echo "{ name:'".$inventariomovimateriale[0]['deno_almacenmateriales']." - Cantidad: ".$cantidad." ', y: ".$porcentaje." },";
                                                       endforeach; 
                                                 ?>
                                             ]
                                    }]
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <?php echo $this->Html->link(__('Volver'), array('action' => 'grafica4')); ?>    
                                    </div>
                                </div>
                            </div>
                    </div>           
