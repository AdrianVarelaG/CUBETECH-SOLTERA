        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Inventario movimientos'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo'<div id="tipo_fuente" style="'.$style.'">';		
	echo'<div class="form-group">';	
	...
	echo $this->Form->input('almacenefunte_id', array('id'=>'Inventariomovimientoalmacenefunte_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
	echo '</div>';	
	echo '</div>';
echo '</div>';	
...
echo'<div class="col-md-9">';			
echo $this->Form->input('ordenventa_id', array('readonly'=>true, 'type'=>'text', 'id'=>'Inventariomovimientoordenventa_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('userventa_id', array('readonly'=>true, 'type'=>'text', 'id'=>'Inventariomovimientouserventa_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
...
<?php /* ?>	<div class="actions">
		...
		<ul>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Inventariomovimiento.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Inventariomovimiento.id'))); ?></li>
