        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Almacen materiales'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
	...
	echo'<div class="col-md-9">';			
	echo $this->Form->input('nombre', array('id'=>'Almacenmaterialenombre', 'div'=>false, 'label'=>false, 'class'=>'form-control', 'onBlur'=>'validar_nombre_almacenmaterial();', 'readonly'=>true));		
	echo '</div>';	
	echo '</div>';
...
<?php /* ?>	<div class="actions">
		...
		<ul>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Almacenmateriale.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Almacenmateriale.id'))); ?></li>
