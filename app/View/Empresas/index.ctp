...
<section class="content">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $empresa['Empresa']['id']), array('class'=>'btn btn-danger', 'confirm'=>__('Esta seguro que desea eliminar el registro # %s?', $empresa['Empresa']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
							</tbody>
