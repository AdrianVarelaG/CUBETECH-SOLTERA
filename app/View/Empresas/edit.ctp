...
echo'<div class="form-group">';	
echo'<label class="control-label col-md-2" for="Empresadirepai_id">Pais</label>';		
echo'<div class="col-md-9">';			
echo $this->Form->input('direpai_id', array('empty'=>'--Seleccione--', 'id'=>'Empresadirepai_id', 'div'=>false, 'label'=>false, 'class'=>'form-control' , "onChange"=>"selectTagRemote('".$this->Html->url('/Empresas/provincia')."', 'div-provincia', this.value);")); 				
echo '</div>';	
echo '</div>';
	
echo'<div class="form-group">';	
echo'<label class="control-label col-md-2" for="Empresadireprovincia_id">Provincia</label>';		
echo'<div class="col-md-9" id="div-provincia">';			
echo $this->Form->input('direprovincia_id', array('id'=>'Empresadireprovincia_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
