        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Almacen tipos'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php /* ?>	<div class="actions">
		...
		<ul>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Almacentipo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Almacentipo.id'))); ?></li>
