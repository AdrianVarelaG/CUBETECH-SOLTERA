        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Add Almacen productos'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
        ...
        echo'<div class="col-md-9">';			
        echo $this->Form->input('nombre', array('id'=>'Almacenproductonombre', 'div'=>false, 'label'=>false, 'class'=>'form-control', 'onBlur'=>'validar_nombre_almacenproductos();'));		
        echo '</div>';	
        echo '</div>';
            ...
            <div id="materiales-container">
                <div id="materialescount">
                    <div class="form-group pro-con" id="producto_0">
                        ...
                        <div class="col-md-2">
							<input class="form-control pro-0-ext text-box single-line" onKeyPress="return solonumeros_con_punto(event);" id="Productos_0__Cantidad" name="data[Almacenmarca][Materiales][0][cant]" type="text"   value="0" required="required" />
                        </div>
                        <div class="col-md-1">
                            <button class="btn btn-danger btn-sm" onclick="$('#producto_0').remove(); return false;"><span class="glyphicon glyphicon-trash"></span></button>
                        </div>
                    </div>
                </div>
            </div>
