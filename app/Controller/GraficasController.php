													            ...
													            'conditions' => array($conditions),
													                ...
													                'fields' => array(' Venta.empresa_id,
													                 	               ...
													                 	               Ventadetalle.almacenproducto_id,
													                 	                ...
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=1 ) as pago_ene,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=2 ) as pago_feb,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=3 ) as pago_mar,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=4 ) as pago_abr,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=5 ) as pago_may,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=6 ) as pago_jun,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=7 ) as pago_jul,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=8 ) as pago_ago,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=9 ) as pago_sep,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=10 ) as pago_obc,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=11 ) as pago_nov,
													                 	                (select COUNT(b.id) from  ventadetalles b, ventas a where b.venta_id=a.id and b.almacenproducto_id=Ventadetalle.almacenproducto_id and (a.pagado=1 or a.pagado=2) and a.activo=1 and month(a.fecha)=12 ) as pago_dic
													                 	              '
													                 	            ),
